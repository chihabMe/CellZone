...
CREATE TABLE "new_Product" (
    ...
    CONSTRAINT "Product_productMarkId_fkey" FOREIGN KEY ("productMarkId") REFERENCES "ProductMark" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
INSERT INTO "new_Product" ("batteryCapacity", "capacity", "cartId", "categoryId", "createdAt", "description", "id", "image", "isBestseller", "isFeatured", "isPopular", "memory", "name", "price", "quantity", "screenSize", "screenType", "slug", "updatedAt", "userId") SELECT "batteryCapacity", "capacity", "cartId", "categoryId", "createdAt", "description", "id", "image", "isBestseller", "isFeatured", "isPopular", "memory", "name", "price", "quantity", "screenSize", "screenType", "slug", "updatedAt", "userId" FROM "Product";
DROP TABLE "Product";
